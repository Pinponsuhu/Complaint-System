...
<body class="w-screen h-screen flex">
    ...
    <main class="w-full">
        ...
        <div class=" rounded-md w-full p-4 bg-white shadow-md">
            <h1 class="text-xl font-medium text-emerald-500 mb-4">All Students</h1>
            <div class="flex rounded-md w-full gap-x-8 p-4 bg-white shadow-md">
                <div class="p-6 w-72 justify-between flex items-center gap-x-5 rounded-md bg-gradient-to-br from-emerald-600 to-emerald-300">
                    <div>
                        <h1 class="text-white font-bold text-xl">Active<br>Students</h1>
                ...
                <div class="p-6 w-72 justify-between flex items-center gap-x-5 rounded-md bg-gradient-to-br from-amber-500 to-amber-300">
                    <div>
                        <h1 class="text-white font-bold text-xl">Banned<br>Student</h1>
            ...
            <table class="w-full">
                <thead>
                    <tr>
                        ...
                        <td class="bg-emerald-700 p-3 text-white font-bold">User Type</td>
                        <td class="bg-emerald-700 p-3 text-white font-bold">School ID</td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="bg-emerald-100 p-3"><{{ $user->user_type }}</td>
                        @php
